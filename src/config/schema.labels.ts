...
export const FIELD_LABELS: Record<string, string> = {
  ...
  financial: "Financial",
  "financial.exchanges": "Exchange Accounts",
  "financial.exchanges.*.exchange": "Exchange Type",
  "financial.exchanges.*.apiKey": "API Key",
  "financial.exchanges.*.secret": "API Secret",
  "financial.exchanges.*.passphrase": "API Passphrase",
  "financial.exchanges.*.testnet": "Testnet Mode",
  "financial.exchanges.*.subaccount": "Sub-account",
  "financial.trading": "Trading Risk Limits",
  "financial.trading.enabled": "Automated Trading Enabled",
  "financial.trading.maxAutoTradeUsd": "Max Auto-Trade (USD)",
  "financial.trading.confirmThresholdUsd": "Confirmation Threshold (USD)",
  "financial.trading.maxDailyLossUsd": "Max Daily Loss (USD)",
  "financial.trading.maxPositionPct": "Max Position Size (%)",
  "financial.trading.maxLeverage": "Max Leverage",
  "financial.trading.allowedPairs": "Allowed Trading Pairs",
  "financial.trading.blockedPairs": "Blocked Trading Pairs",
  "financial.expertSdk": "Expert SDK",
  "financial.expertSdk.apiKey": "Expert SDK API Key",
  "financial.expertSdk.endpoint": "Expert SDK Endpoint",
  "financial.expertSdk.tier": "Expert SDK Tier",
  "financial.infoFeedSdk": "Info Feed SDK",
  "financial.infoFeedSdk.apiKey": "Info Feed API Key",
  "financial.infoFeedSdk.endpoint": "Info Feed Endpoint",
  plugins: "Plugins",
